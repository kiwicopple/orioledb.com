...
![Undo circular buffer](/img/docs/undo_buffer_1.svg)
...
![Undo circular buffer overflow](/img/docs/undo_buffer_2.svg)
...
![Undo log split](/img/docs/undo_buffer_3.svg)
...
![Undo log write in-progress](/img/docs/undo_buffer_4.svg)
...
![Undo log written](/img/docs/undo_buffer_5.svg)
