...
![Checkpoint walk the tree](/img/docs/checkpoint_walk.svg)
...
![Checkpoint state 1](/img/docs/checkpoint_state_1.svg)
...
![Checkpoint state 1](/img/docs/checkpoint_state_2.svg)
