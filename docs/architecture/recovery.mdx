...
![Distribution of messages to recovery queues](/img/docs/recovery_distribute.svg)
...
![Undo chains during recovery](/img/docs/recovery_undo.svg)
...
![Versions for toast tuples](/img/docs/toast_version.svg)
...
![Recovery of secondary indexes](/img/docs/recovery_secondary_indexes.svg)
