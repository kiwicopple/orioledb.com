...
This feature is currently experimental and should be used with caution. These are not included in the patch set we have submitted to PostgreSQL. They are being developed and tested for future releases.
